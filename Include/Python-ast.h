...
enum _expr_kind {BoolOp_kind=1, BinOp_kind=2, UnaryOp_kind=3, Lambda_kind=4,
                  ...
                  AssignExpr_kind=25, Attribute_kind=26, Subscript_kind=27,
...
expr_ty _Py_Constant(constant value, int lineno, int col_offset, PyArena
                     *arena);
#define AssignExpr(a0, a1, a2, a3, a4) _Py_AssignExpr(a0, a1, a2, a3, a4)
expr_ty _Py_AssignExpr(expr_ty target, expr_ty value, int lineno, int
                       col_offset, PyArena *arena);
